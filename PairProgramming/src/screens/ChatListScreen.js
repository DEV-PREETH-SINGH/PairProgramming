...
const ChatListScreen = () => {
  ...
  useEffect(() => {
    // Initialize socket for receiving notifications only
    ...
    socket.on("connect", () => {
      ...
      // Register this user for receiving messages
      if (currentUserUID) {
    ...
    socket.on("newMessage", (data) => {
      console.log("ChatList: New message notification received", data);
    ...
    const fetchPartnerUID = async () => {
      ...
      try {
        ...
        setPartnerUID(response.data.partnerUID);
      } catch (error) {
